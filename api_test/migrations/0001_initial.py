# Generated by Django 2.0.2 on 2020-04-29 18:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('examineType', models.CharField(choices=[('no_check', '不校验'), ('only_check_status', '校验http状态'), ('json', 'JSON校验'), ('entirely_check', '包含校验'), ('Regular_check', '正则校验')], default='no_check', max_length=50, verbose_name='校验方式')),
