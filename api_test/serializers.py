...
class GlobalHostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = GlobalHost
        fields = ('id', 'project_id', 'name', 'host', 'status', 'description','username','password','url','LastUpdateTime','value')
        # fields = "__all__"
...
class AutomationParameterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'automationCaseApi', 'name', 'value', 'interrelate','parInterrelate','_type')
...
class AutomationParameterDeserializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AutomationParameter
        fields = ('id', 'automationCaseApi_id', 'name', 'value', 'interrelate','parInterrelate','_type')
...
class AutomationCaseApiSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'name', 'httpType', 'requestType', 'apiAddress', 'header', 'requestParameterType', 'formatRaw',
                  'parameterList', 'parameterRaw', 'examineType', 'httpCode', 'responseData','exeSequence')
...
class AutomationTestTaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'project', 'Host', 'name', 'type', 'frequency')
...
class GlobalTokenSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = GlobalToken
        fields="__all__"
class ParameterVariableSerializer(serializers.ModelSerializer):
    """
    GlobalToken序列化
    """
    class Meta:
...
class ParameterListSerializer(serializers.ModelSerializer):
    ...
    GlobalToken序列化
    """
    testCaseName = serializers.CharField(source='automationTestCase.caseName')
    apiName = serializers.CharField(source='automationCaseApi.name')
    class Meta:
        model = ParameterVariable
        fields="__all__"
...
class GlobalTokenSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = GlobalToken
        fields="__all__"
class PublicVariableSerializer(serializers.ModelSerializer):
    """
    自定义参数
    """
    class Meta:
        model = PublicVariable
        fields="__all__"
class DataBaseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = DataBase
        fields=('id', 'project_id', 'type', 'host', 'user', 'passwd','dataname','name')
...
#     class Meta:
#         model = GlobalHost
#         fields = ('id', 'project_id', 'name', 'host', 'status', 'description', 'username', 'password', 'url',
...
class AutomationAutoTestResultSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'automationTestCase', 'name', 'httpType', 'header', 'requestType', 'apiAddress', 'examineType',
                  'result', 'parameter', 'httpStatus', 'responseHeader', 'responseData', 'testTime','caseUrl')
