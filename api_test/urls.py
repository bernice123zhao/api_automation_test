...
from api_test.api.globalToken import *
from api_test.common import auto_test
from api_test.api import timing
from api_test.api.DataBase import *
from api_test.api.timing_list import Timimg_list
from api_test.common.PublicVariableData import *
from api_test.api.globalCustom import *
urlpatterns = [
    ...
    url(r'automation/run_all_case', Case.RunAllCase.as_view()),
    url(r'automation/CopyApi', Case.CopyApi.as_view()),
    url(r'automation/CopyCase', Case.CopyCase.as_view()),
    ...
    url(r'token/add', AddToken.as_view()),
    url(r'token/LoginToken', AddLoginToken.as_view()),
    url(r'token/listToken', TokenList.as_view()),
    url(r'task/timing_list', Timimg_list.as_view()),
    url(r'task/AllRun', auto_test.automation_task),
    url(r'task/timing', timing.test_add_task),
    url(r'data/get_parameter', ParameList.as_view()),
    url(r'database/addData', AddDataBase.as_view()),
    url(r'database/getData', DataBaseList.as_view()),
    url(r'database/updateData', UpdateDataBase.as_view()),
    url(r'database/delDataBase', DelDataBase.as_view()),
    url(r'database/testConnection', TestConnection.as_view()),
    url(r'custom/GetPublicVariable', GlobalCustom.as_view()),]
