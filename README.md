...
体验地址：http://172.22.7.87  请体验用户不要删除已有数据<br>
...
1.增加导出测试用例功能<br>
## V2.1.1<br>
1.新增swaggerUI界面，访问地址127.0.0.1:8020/docs/<br>
## V2.1<br>
1.优化前端代码，适配屏幕分辨率，未做浏览器兼容性，目前只在chrome上浏览正常<br>
2.新增mock功能，api管理模块可启动，关闭mock，启动后，通过访问http://127.0.0.1:8020/mock/+真实url，可返回mock信息
## V2.0<br>
...
```
### 12.现在就可以访问 http://127.0.0.1:8020/login 进行登录， http://127.0.0.1:8020/admin 为后台管理平台<br>
## 微信打赏：<br>
