...
ALLOWED_HOSTS = ['172.22.7.87', '127.0.0.1', '172.22.7.87',
                 '172.22.7.87', '192.168.1.10', 'apitest.60community.com', '*']
...
DATABASES = {
    ...
    #     'PASSWORD': 'slb@123456',
    #     # 'HOST': '172.22.32.41',
    #     'HOST': 'rm-wz95e477st682q0258o.mysql.rds.aliyuncs.com',
    #     'PORT': '3306'
    # }
