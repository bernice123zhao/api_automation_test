...
const getTiming = () => import('./views/project/TimingTask.vue')
const DataBase = () => import('./views/project/global/DataBase.vue')
const GlobalParameter = () => import('./views/project/global/GlobalParameter.vue')

const addLoginToken = () => import('./views/project/AddLoginToken.vue')
const GlobalLogin = () => import('./views/project/global/GlobalLogin.vue')
let routes = [
    {
        path: '/login',
        component: Login,
    ...
    },
    {
        ...
        children: [
            ...
            {   path: '/projectReport/project=:project_id', component: ProjectReport, name: '自动化测试报告', leaf: true},
             {   path: '/project/timing/project=:project_id', component: getTiming, name: '定时计划', leaf: true},
            {   path: '/project/database/project=:project_id', component: DataBase, name: '数据库信息', leaf: true},
            {   path: '/project/parameter/project=:project_id', component: GlobalParameter, name: '公共参数', leaf: true},
            //     {   path: '/project/addToken/project=:project_id', component: addLoginToken, name: '添加token', leaf: true},
            // {   path: '/project/addLoginToken/project=:project_id', component: GlobalLogin, name: '添加token2', leaf: true},
            ]
    },
];
