<template>
    <div style="margin:35px">
        ...
        <el-table :data="project" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="username" label="用户名" min-width="15%" sortable show-overflow-tooltip>
            </el-table-column>
                     <el-table-column prop="password" label="密码" min-width="15%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="url" label="地址" min-width="28%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="value" label="Token" min-width="28%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="LastUpdateTime" label="上次更新" min-width="28%" sortable show-overflow-tooltip>
            </el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false" style="width: 60%; left: 20%">
            <el-form :model="editForm"  :rules="editFormRules" ref="editForm" label-width="80px">
                ...
                <el-form-item label="密码" prop='password'>
                    <el-input v-model.trim="editForm.password" auto-complete="off"></el-input>
                </el-form-item>
                    ...
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            let params = {
                                ...
                                password: self.editForm.password,
