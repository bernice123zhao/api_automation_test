    ...
    <div style="margin:35px">
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters" @submit.native.prevent>
                <el-form-item>
                    <el-input v-model.trim="filters.name" placeholder="名称" @keyup.enter.native="getGlobalToken"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" @click="getGlobalToken">查询</el-button>
                </el-form-item>
                <el-form-item>
        ...
        <el-table :data="project" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="username" label="账号" min-width="15%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="password" label="密码" min-width="28%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="url" label="地址" min-width="27%" sortable show-overflow-tooltip>
            </el-table-column>
        ...
        <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false" style="width: 60%; left: 20%">
            <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
                ...
                <el-form-item label="密码" prop='host'>
...
<script>
    ...
    updateHost, addHost,getLoginList} from '../../../api/api'
    export default {
        data() {
